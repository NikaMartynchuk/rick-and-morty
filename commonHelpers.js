import{g as p}from"./assets/animated-element-5b4e2e0c.js";import"./assets/vendor-6837a909.js";const l=document.getElementById("character-list"),s=document.querySelector(".load-more"),h=document.querySelector(".character-input"),f=document.querySelectorAll(".character select");let c=1,d=!1,o={};function y(e,r=!1){if(r&&(l.innerHTML=""),!e||e.length===0){l.innerHTML="<li>No characters found.</li>",s.style.display="none";return}const a=e.map(t=>`
    <li>
